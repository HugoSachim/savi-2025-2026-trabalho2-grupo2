...
class Trainer():
    ...
    def draw(self):
        ...
        if len(self.train_epoch_losses) > 0:
            plt.plot(range(len(self.train_epoch_losses)), self.train_epoch_losses, 'r-', label='Train')
        
        if len(self.test_epoch_losses) > 0:
            plt.plot(range(len(self.test_epoch_losses)), self.test_epoch_losses, 'b-', label='Test')
